...
// 이 파일은 estree-jsx 패키지의 타입을 확장하는 파일입니다.

import type { BaseExpression, BaseNode, Expression, Literal } from "estree";
...
export interface JSXAttribute extends BaseNode {
  ...
  value: Literal | JSXExpressionContainer | JSXElement | JSXFragment | null | StringLiteral;
}
